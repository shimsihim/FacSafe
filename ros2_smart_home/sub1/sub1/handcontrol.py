...
class Handcontrol(Node):
    ...
    def hand_control_status(self):
        ...
        print("Lift Available : " + str(self.turtlebot_status_msg.can_lift))
        print("Put Available : " + str(self.turtlebot_status_msg.can_put))
        print("Hand Available : " + str(self.turtlebot_status_msg.can_use_hand))
